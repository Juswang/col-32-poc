                ...
                if (!isBeginConnected || isEndConnected) {
                    if (!isBeginConnected && isEndConnected) {
                        ...
                        if (applyBoundsCheck2) {
                            ...
                            begin2 = begin3;
                            int numConnections5 = centeringStrength;
                            system.addCentering(begin3, beginTarget2, beginAnchor.getMargin(), bias, endTarget, end2, endAnchor.getMargin(), numConnections5);
