...
public class TextAppearance {
    ...
    public void getFontAsync(Context context, final TextPaint textPaint, @NonNull final TextAppearanceFontCallback callback) {
    ...
    public void updateDrawState(Context context, TextPaint textPaint, @NonNull TextAppearanceFontCallback callback) {
    ...
    public void updateMeasureState(Context context, TextPaint textPaint, @NonNull TextAppearanceFontCallback callback) {
        if (TextAppearanceConfig.shouldLoadFontSynchronously()) {
