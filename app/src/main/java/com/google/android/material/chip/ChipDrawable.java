...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback {
    ...
    private final TextAppearanceFontCallback fontCallback = new TextAppearanceFontCallback() { // from class: com.google.android.material.chip.ChipDrawable.1
    ...
    private ChipDrawable(Context context, AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private void drawChipSurface(@NonNull Canvas canvas, Rect bounds) {
        ...
        getPathForSize(bounds, this.shapePath);
    ...
    private void drawText(@NonNull Canvas canvas, Rect bounds) {
        if (this.text != null) {
            ...
            if (clip && this.truncateAt != null) {
                finalText = TextUtils.ellipsize(this.text, this.textPaint, this.rectF.width(), this.truncateAt);
            }
    ...
    private boolean onStateChange(int[] chipState, int[] closeIconState) {
        ...
        int newCompatRippleColor = colorStateList4 != null ? colorStateList4.getColorForState(chipState, this.currentCompatRippleColor) : 0;
        ...
        if (colorStateList5 != null) {
            newTint = colorStateList5.getColorForState(chipState, this.currentTint);
        }
