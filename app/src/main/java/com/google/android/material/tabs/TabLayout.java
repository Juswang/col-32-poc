...
public class TabLayout extends HorizontalScrollView {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    protected OnTabSelectedListener wrapOnTabSelectedListener(@Nullable final BaseOnTabSelectedListener baseListener) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int idealHeight = (int) (ViewUtils.dpToPx(getContext(), getDefaultHeight()) + getPaddingTop() + getPaddingBottom());
