...
app.definitions.CommentSection = /** @class */ (function () {
            ...
            if (this.sectionProperties.selectedComment && !$(this.sectionProperties.selectedComment.sectionProperties.container).hasClass('annotation-active')) {
                ...
                if (this.sectionProperties.docLayer._docType === 'text') {
                    ...
                    if (id.indexOf('new') < 0 && !this.isInViewPort(this.sectionProperties.selectedComment)) {
                        var scrollToPos = this.sectionProperties.selectedComment.position[1];
    ...
    CommentSection.prototype.isInViewPort = function (annotation) {
        ...
        var annotationTop = annotation.position[1];
        var annotationBottom = annotation.position[1] + rect.bottom - rect.top;
