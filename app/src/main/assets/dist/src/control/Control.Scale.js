...
L.Control.Scale = L.Control.extend({
    ...
    _update: function () {
        ...
        var maxMeters = L.CRS.Earth.distance(map.containerPointToLatLngIgnoreSplits([0, y]), map.containerPointToLatLngIgnoreSplits([this.options.maxWidth, y]));
...
//# sourceMappingURL=Control.Scale.js.map