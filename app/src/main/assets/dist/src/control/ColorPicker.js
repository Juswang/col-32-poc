...
L.ColorPicker = L.Class.extend({
    ...
    _createPseudoColorControl: function () {
        ...
        var label = noColorControl ? { type: 'fixedtext', style: 'no-color-control-label', text: _('No color') }
        ...
        var checked = noColorControl ? { type: 'fixedtext', id: this._noColorControlId, style: 'no-color-control-mark', text: '' }
