...
L.Control.Menubar = L.Control.extend({
    ...
    options: {
        ...
        allowedViewModeActions: [
            'savecomments', 'shareas', 'print',
            'downloadas-pdf', 'downloadas-odt', 'downloadas-doc', 'downloadas-docx', 'downloadas-rtf', 'downloadas-epub',
            'downloadas-odp', 'downloadas-ppt', 'downloadas-pptx', 'downloadas-odg', 'print',
            'downloadas-ods', 'downloadas-xls', 'downloadas-xlsx', 'downloadas-csv', 'closedocument',
            'fullscreen', 'zoomin', 'zoomout', 'zoomreset', 'showresolved',
            'about', 'keyboard-shortcuts', 'latestupdates', 'feedback', 'online-help', 'report-an-issue',
            'insertcomment'
        ]
    },
    onAdd: function (map) {
