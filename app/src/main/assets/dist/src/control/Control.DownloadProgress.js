...
L.Control.DownloadProgress = L.Control.extend({
    ...
    _ignoreEvents: function (elem) {
        L.DomEvent.on(elem, 'mousedown mouseup mouseover mouseout mousemove', function (e) {
    ...
    _download: function () {
        var that = this;
        this._map._clip._doAsyncDownload('GET', that._uri, null, true, function (response) {
